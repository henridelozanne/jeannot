    ...
    <div class="hero">
      ...
      <div class="ctnr">
        <div class="temoignage-ctn evelyn">
          <div class="inner-ctn">
            <img src="../assets/evelyn.png">
            <p class="caption">
              Evelyn, Psychologue clinicienne
            </p>
          </div>
          <p class="say">
        ...
        <div class="temoignage-ctn jeanne">
          ...
          <div class="inner-ctn">
            <img src="../assets/jeanne.png">
            <p class="caption">
              Jeanne, Éducatrice spécialisée
            </p>
          </div>
        </div>
      </div>
...
section {
  ...
  .hero {
    ...
    .ctnr {
      ...
      box-shadow: 0px 2px 7px rgba(139, 139, 139, 0.2);
      padding: 20px;
    ...
    h1 {
      ...
      font-weight: 700;
      width: fit-content;
      border-bottom: 3px solid rgb(46, 217, 166);
    }
    ...
    .auticto {
        ...
        button {
          ...
          cursor: pointer;
          align-self: center;
          box-shadow: 0px 2px 7px rgba(139, 139, 139, 0.3);
